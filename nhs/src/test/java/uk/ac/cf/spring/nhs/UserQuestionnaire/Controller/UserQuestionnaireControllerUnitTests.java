...
class UserQuestionnaireControllerUnitTests {
        ...
        void testGetUserQuestionnaire() {
                ...
                ResponseEntity<UserQuestionnaire> response = userQuestionnaireController
                                .getUserQuestionnaire(questionnaireId);
        ...
        void testAssignQuestionnaireToPatient() {
                ...
                userQuestionnaire.setQuestionnaireDueDate(LocalDate.now().plusDays(7)); // Setting a due date 7 days in
                                                                                        // the
                                                                                        // future
        ...
        void testUpdateUserQuestionnaire_StartDateIsNotOverwritten() {
                ...
                userQuestionnaire.setQuestionnaireInProgress(false); // Assume it was initially not in progress
                when(userQuestionnaireService.getUserQuestionnaire(123L, questionnaireId))
                                .thenReturn(Optional.of(userQuestionnaire));
                ...
                updatedUserQuestionnaire.setQuestionnaireInProgress(true); // This should NOT update the original object
                updatedUserQuestionnaire.setQuestionnaireStartDate(LocalDateTime.now()); // This should NOT overwrite
                                                                                         // the
                                                                                         // original start date
                ...
                assertEquals(false, response.getBody().getQuestionnaireInProgress(),
                                "The questionnaireInProgress should not be updated");
                verify(userQuestionnaireService, times(1)).saveUserQuestionnaire(userQuestionnaire);
        }

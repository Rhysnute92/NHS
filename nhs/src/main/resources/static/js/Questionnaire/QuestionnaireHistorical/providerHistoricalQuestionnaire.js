...
let chart;
const patientId = 2; // Replace this with dynamic fetching of patientId
...
$(document).ready(function () {
  ...
  // Fetch completed user questionnaires for the patient and display them
  questionnaireService
    .getCompletedUserQuestionnairesForPatient(patientId)
    .then((data) => {
      console.log("Fetched UserQuestionnaires for Patient:", data);

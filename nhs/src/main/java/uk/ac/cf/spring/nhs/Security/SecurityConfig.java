...
public class SecurityConfig{
    ...
    //Any changes can be made in the associated CustomAuthenticationSuccessHandler.java file
    @Bean
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        .authorizeHttpRequests(request -> request
                ...
                .anyRequest().authenticated() //Ensures all other requests can be done by any authenticated user
                )
